...
export default function Analytic() {
    ...
    return (
        <ScrollView style={{ backgroundColor : PRIMARY_COLOR_WHITE, flex : 1 }}>
            ...
            <View style={styles.container}>
                <Svg style={{ position : 'absolute' }}>  
                    ...
                    <Circle
                        ...
                        strokeDashoffset={CIRCLE_LENGHT * 0.1}
                        strokeLinecap="round"
                    />
                    <Circle
                        ...
                        strokeWidth={10}
                        strokeDasharray={CIRCLE_LENGHT}
                        strokeDashoffset={CIRCLE_LENGHT * 0.7}
                        strokeLinecap="round"    
                    />                     
                </Svg>
                <Text style={[StyleSheet.absoluteFillObject, {
                    position : 'absolute',
                    left : FULL_WIDTH / 4 - 20,
                    top : FULL_WIDTH / 4 - 25,
                    fontSize : 35,
                    fontWeight : 'bold',
                    color : PRIMARY_COLOR
            ...
            <View style={{ backgroundColor : PRIMARY_COLOR, marginHorizontal : 20, borderRadius : 20, padding : 10, flexDirection : 'row', marginVertical : 10 }}>
                <View style={{ flex : 0.5 }}>
                    <View style={{ marginVertical : 10, alignItems : 'center' }}>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontWeight : 'bold', fontSize : 16 }}>{vndFormat.format(20000000)}</Text>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontSize : 13, marginTop : 5 }}>Số tiền đã đầu tư</Text>             
                    </View>
                    <View style={{ marginVertical : 10, alignItems : 'center' }}>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontWeight : 'bold', fontSize : 16 }}>{vndFormat.format(5000000)}</Text>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontSize : 13, marginTop : 5 }}>Tổng lãi</Text>        
                    </View>
                </View>
                <View style={{ flex : 0.5 }}>
                    <View style={{ marginVertical : 10, alignItems : 'center' }}>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontWeight : 'bold', fontSize : 16 }}>{vndFormat.format(20000000)}</Text>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontSize : 13, marginTop : 5 }}>Số tiền đã nhận</Text>             
                    </View>
                    <View style={{ marginVertical : 10, alignItems : 'center' }}>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontWeight : 'bold', fontSize : 16 }}>{vndFormat.format(2000000)}</Text>
                        <Text style={{ color : PRIMARY_COLOR_WHITE, fontSize : 13, marginTop : 5 }}>Lãi đã nhận được</Text>        
                    </View>
                </View>
            </View>
