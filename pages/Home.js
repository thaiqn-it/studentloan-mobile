...
export default function Home({ navigation }) {
      ...
      <View
        ...
        <View
          ...
          <View>
            ...
            <Text style={styles.textItem}>School: {item.school}</Text>
            <Text style={styles.textItem}>Ses: {item.sesmester}</Text>
            <Text style={styles.textItem}>Major: {item.major}</Text>
  ...
  return (
    <SafeAreaView
      style={{ backgroundColor: PRIMARY_COLOR, flex: 1, paddingTop: 50 }}>
      <SearchBar
        platform="ios"
        containerStyle={{
          marginTop: 10,
